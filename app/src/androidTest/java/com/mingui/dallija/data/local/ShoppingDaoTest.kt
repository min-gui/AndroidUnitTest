package com.mingui.dallija.data.local
...
import com.mingui.dallija.getOrAwaitValue
...
class ShoppingDaoTest {
    ...
    fun insertShoppingItem() = runBlockingTest {
        ...
        var allShoppingItems = dao.observeAllShoppingItems().getOrAwaitValue()
    ...
    @Test
    fun ovserveTotalPriceSum() = runBlockingTest {
